      ...
      <form className="grid gap-4 md:grid-cols-2" onSubmit={(e) => e.preventDefault()}>
        ...
        <label className="md:col-span-2">
          ...
          <textarea
            ...
            rows={6}
            className="min-h-[160px] w-full rounded-[22px] border border-white/10 bg-black/20 px-4 py-3 text-sm text-white placeholder:text-white/[0.32] transition-all duration-300 focus:border-gold/35 focus:bg-white/[0.04] focus:outline-none focus:ring-2 focus:ring-gold/[0.35]"
          />
        </label>
  ...
  return (
    <label>
      ...
      <input
        ...
        className="w-full rounded-[18px] border border-white/10 bg-black/20 px-4 py-3 text-sm text-white placeholder:text-white/[0.32] transition-all duration-300 focus:border-gold/35 focus:bg-white/[0.04] focus:outline-none focus:ring-2 focus:ring-gold/[0.35]"
      />
    </label>
  );
}
