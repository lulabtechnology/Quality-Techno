        ...
        <div className="panel overflow-hidden p-8 md:p-10 lg:p-12">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <MotionStagger className="mt-8 space-y-4" delay={0.08}>
                <MotionItem>
                  <HoverLift>
                    <div className="rounded-[22px] border border-white/10 bg-black/20 p-5 transition-all duration-500 hover:border-gold/30 hover:bg-white/[0.05]">
