...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pb-10 pt-14 md:pb-16 md:pt-20">
      <div className="absolute inset-x-0 top-0 h-[620px] bg-[radial-gradient(circle_at_18%_8%,rgba(215,181,109,0.16),transparent_0,transparent_28%),radial-gradient(circle_at_82%_14%,rgba(82,130,191,0.24),transparent_0,transparent_30%)]" />
      <div className="shell relative grid items-center gap-14 lg:grid-cols-[1.02fr_0.98fr]">
        <div>
          ...
          <h1 className="mt-6 max-w-4xl text-[3rem] font-semibold leading-[0.9] text-white sm:text-[3.8rem] md:text-[5.5rem]">
            Soluciones técnicas para operaciones que no pueden detenerse.
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/[0.74] md:text-xl">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {credibility.map((item) => (
              <div key={item} className="panel-dark p-4">
        ...
        <div className="relative">
          <div className="absolute inset-x-[12%] top-[-8%] h-44 rounded-full bg-gold/15 blur-3xl" />
          <IndustrialVisual className="animate-float" />
